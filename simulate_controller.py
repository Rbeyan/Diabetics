...
from simglucose_gym_env import T1DAdultSimEnv
from custom_rewards import partial_negativity

latest_saved_model = r"C:\Users\yanni\diabetes-RL-project\test\new_model\adult.zip"

controller = PPOController(0, latest_saved_model)

now = datetime.now()
start_time = datetime.combine(now.date(), datetime.min.time())
path = r"C:\Users\yanni\diabetes-RL-project\results"

patient = T1DPatient.withName('adult#005')
sensor = CGMSensor.withName('Dexcom', seed=1)
pump = InsulinPump.withName('Insulet')

scen = [(2, 70), (10, 30), (14, 110), (21, 90)]
